...
public class Day4 {
	public static void main(String[] args) {
		...
		System.out.println(Arrays.stream(passphrases).filter(Day4::passphraseIsFreeOfDuplicates).count());
		System.out.println(Arrays.stream(passphrases).filter(Day4::passphraseIsFreeOfAnagrams).count());
	}
